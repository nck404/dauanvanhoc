<script>
    ...
    let relatedWorks = $derived.by(() => {
        ...
        // Giả lập phân bổ tác phẩm dựa trên độ dài tên
    ...
    onMount(async () => {
        ...
        if (typeof window !== 'undefined') {
            ...
            // Sử dụng bản đồ đen trắng của CartoDB (Rất hợp với Newsprint)
...
<div class="page-container">
    ...
    <div class="map-layout reveal reveal-delay-1">
...
<style>
    ...
    .map-view {
        ...
        height: 600px;
        overflow: hidden;
        z-index: 1; /* For leaflet stacking context */
    }
