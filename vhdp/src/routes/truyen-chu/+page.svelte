...
<div class="page-container">
    <header class="header-section">
        <span class="label">Tác phẩm chữ</span>
        <h1>Kho tàng <em>truyện chữ</em> truyền bản<span class="dot">.</span></h1>
        <p class="lead">Hàng ngàn tác phẩm văn học chữ, tiểu thuyết lịch sử và thơ ca truyền thống được lưu giữ nguyên vẹn bản điện tử.</p>
    ...
    <section class="content-section">
        <div class="book-grid">
            ...
            {:else if filteredBooks.length === 0}
                <div class="empty">
                    Không tìm thấy tác phẩm truyện chữ nào.
                </div>
            {:else}
